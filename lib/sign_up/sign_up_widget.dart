                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              if (!(_model.uniqueUsername !=
                                                                      null &&
                                                                  (_model.uniqueUsername)!
                                                                      .isNotEmpty)) {
                                                                if (functions
                                                                    .doesPasswordFit(_model
                                                                        .passwordCreateTextController
                                                                        .text)) {
                                                                  GoRouter.of(
                                                                          context)
                                                                  ...
                                                                  ScaffoldMessenger.of(
                                                                    ...
                                                                    SnackBar(
                                                                      content:
                                                                          Text(
                                                                        'Şifre en az 8 karakter uzunluğunda olmalı, büyük/küçük harf ve rakamiçermelidir.',
                                                                        style:
                                                                            TextStyle(
                                                                          color:
                                                                              Colors.white,
                                                                ...
                                                                ScaffoldMessenger.of(
                                                                  ...
                                                                  SnackBar(
                                                                    content:
                                                                        Text(
                                                                      'Benzersiz bir kullanıcı adı seçmelisiniz.',
                                                                      style:
                                                                          TextStyle(
                                                                        color: Colors
                                                                            .white,
                                                                      ...
                                                                      : Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              context.goNamedAuth(AnaEkranWidget.routeName, context.mounted);
                                                                            },
                                                                            text:
                                                                                'Continue with Apple',
                                                                            icon:
